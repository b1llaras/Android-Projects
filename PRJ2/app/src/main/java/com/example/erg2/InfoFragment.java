...
public class InfoFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            perioxi = savedInstanceState.getString("perioxi");
            poli = savedInstanceState.getString("poli");
        }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if(savedInstanceState==null && bundle != null) {
            perioxi = bundle.getString("perioxi");
            poli = bundle.getString("poli");
        }

        TextView tv = view.findViewById(R.id.tv);
        tv.setText("A city in the region of " + perioxi.toUpperCase() + " is " + poli.toUpperCase());

        wiki = view.findViewById(R.id.floatingActionButton);
        map = view.findViewById(R.id.floatingActionButton2);
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putString("perioxi", perioxi);
        outState.putString("poli", poli);
    }
}